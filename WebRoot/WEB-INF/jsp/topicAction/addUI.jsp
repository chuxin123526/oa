...
<!--显示表单内容-->
<div id="MainArea">
<form action="topicAction_add.action" style="margin: 0; padding: 0;">
	...
	<center>
		<div class="ItemBlock_Title1">
			<div width=85% style="float:left">
				...
				<font class="MenuPoint"> &gt; </font>
				<a href="forumAction_show.action?forum.id=${forum.id}">${forum.name}</a>
				<font class="MenuPoint"> &gt;&gt; </font>
				发表新主题
			</div>
		</div>
		<div class="ItemBlockBorder">
			<table border="0" cellspacing="1" cellpadding="1" width="100%" id="InputArea">
				<tr>
					...
					<s:textfield name = "topic.title" cssClass = "InputStyle" cssStyle="width:100%"></s:textfield>
						</div>
					</td>
				</tr>
				<tr>
