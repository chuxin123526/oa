...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="<%=basePath %>style/images/title_arrow.gif"/> 查看主题
        </div>
...
<div id="MainArea">
	...
	<center>
		<div class="ItemBlock_Title1" style="width: 98%">
			...
			<font class="MenuPoint"> &gt;&gt; </font>
			帖子阅读
			<span style="margin-left:30px;"><a href="topicAction_addUI.action?forum.id=${topic.forum.id}">
				<img align="absmiddle" src="<%=basePath %>style/blue/images/button/publishNewTopic.png"/></a>
			</span>
		</div>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<td width="3" class="ForumPageTableTitleLeft">&nbsp;</td>
					...
					<td class="ForumPageTableTitle" align="right" style="padding-right:12px;">
						<a class="detail" href="replyAction_addUI.action?topic.id=${topic.id}"><img border="0" src="replyAction_addUI.action?topic.id=${topic.id}" />回复</a>
						<a href="moveUI.html"><img border="0" src="<%=basePath %>style/images/edit.gif" />移动到其他版块</a>
						<a href="#" onClick="return confirm('要把本主题设为精华吗？')"><img border="0" src="<%=basePath %>style/images/forum_hot.gif" />精华</a>
						<a href="#" onClick="return confirm('要把本主题设为置顶吗？')"><img border="0" src="<%=basePath %>style/images/forum_top.gif" />置顶</a>
						<a href="#" onClick="return confirm('要把本主题设为普通吗？')"><img border="0" src="<%=basePath %>style/images/forum_comm.gif" />普通</a>
					</td>
					...
					<tr>
						<td rowspan="3" width="130" class="PhotoArea" align="center" valign="top">
							...
							<div class="AuthorPhoto">
								<img border="0" width="110" height="110" src="<%=basePath %>style/images/defaultAvatar.gif" 
						...
						<td align="center">
							<ul class="TopicFunc">
								...
								<li class="TopicFuncLi">
									<a class="detail" href="<%=basePath %>BBS_Topic/saveUI.html"><img border="0" src="<%=basePath %>style/images/edit.gif" />编辑</a>
									<a class="detail" href="#" onClick="return confirm('确定要删除本帖吗？')"><img border="0" src="<%=basePath %>style/images/delete.gif" />删除</a>
								</li>
								<!-- 文章表情与标题 -->
								<li class="TopicSubject">
									<img width="19" height="19" src="<%=basePath %>style/images/face/face1.gif"/>
									新手发帖
								</li>
							</ul>
						</td>
						...
						<td class="Footer" height="28" align="center" valign="bottom">
							<ul style="margin: 0px; width: 98%;">
								<li style="float: left; line-height:18px;"><font color=#C30000>[楼主]</font>
									<s:date name="topic.postTime"/>
								</li>
								<li style="float: right;"><a href="javascript:scroll(0,0)">
									<img border="0" src="<%=basePath %>style/images/top.gif" /></a>
								</li>
							</ul>
						</td>
					</tr>
						...
						<tr>
							...
							<td align="center">
								<ul class="TopicFunc">
									...
									<!-- 文章表情与标题 -->
									<li class="TopicSubject">
										<img width="19" height="19" src="<%=basePath %>style/images/face/${reply.faceIcon}"/>
										${title}
									</li>
								</ul>
							</td>
			...
			<table border="0" cellspacing="1" width="98%" cellpadding="5" class="TableStyle">
				...
				<tr class="Tint" height="200">
					...
					<td valign="top" class="no_color_bg">
						<textarea name="topic.content" style="width: 95%; height: 300px"></textarea>
					</td>
				</tr>
				<tr height="30" class="Tint">
