					...
					<tr height="78" align="center" class="template">
						...
						<td class="ForumPageTableDataLine">
							<ul class="ForumPageTopicUl">
								<li class="ForumPageTopic"><a class="ForumPageTopic" href="forumAction_show.action?forum.id=${id}">${name}</a></li>
						...
						<td class="ForumPageTableDataLine">
							<ul class="ForumPageTopicUl">
								<li><font color="#444444">┌ 主题：</font> 
									<a class="ForumTitle" href="<%=basePath %>BBS_Topic/topicShow.html">${forum.lastTopic.title}</a>
								</li>
