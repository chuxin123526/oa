...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="<%=basePath %>style/images/title_arrow.gif"/> 【常见问题】中的主题列表
        </div>
...
<div id="MainArea">
	...
	<center>
		<div class="ItemBlock_Title1" style="width: 98%;">
			...
			<font class="MenuPoint"> &gt; </font>
			${forum.name}
			<span style="margin-left:30px;"><a href="topicAction_addUI.action?forum.id=${forum.id}">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<s:iterator value = "#topicList">
					<tr height="35" id="d0" class="template">
						<td></td>
						<td class="ForumTopicPageDataLine" align="center"><img src="<%=basePath %>style/images/topicType_${type}.gif" /></td>
						<td class="Topic"><a class="Default" href="topicAction_show.action?topic.id=${id}">${title}</a></td>
						<td class="ForumTopicPageDataLine">
							<ul class="ForumPageTopicUl" style="margin: 0 ; padding:0 ;">
