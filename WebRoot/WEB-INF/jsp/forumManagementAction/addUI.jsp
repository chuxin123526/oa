...
<!--显示表单内容-->
<div id="MainArea">
    <s:form action="forumManagementAction_add">
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                        ...
                        <td><s:textfield name="forum.name" cssClass="InputStyle"></s:textfield>
                        </td>
                    </tr>
                    <tr>
                        <td>版块说明</td>
                        <td><s:textarea name="forum.description" cssClass="TextareaStyle"></s:textarea>
                        </td>
                    </tr>
                </table>
            </div>
